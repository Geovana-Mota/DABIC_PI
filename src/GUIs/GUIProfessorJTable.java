...
public class GUIProfessorJTable extends JDialog {
...
//  ------------------------------------------------------------------------------------------------------ 
    ...
    public GUIProfessorJTable(Point posicao, Dimension dimensao) {
        ...
        tableModel = new ProfessorTableModel(lista);
            ...
            public void actionPerformed(ActionEvent evt) {
                if (table.getSelectedRow() >= 0) {
                    ...
                    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(cp,
                            "Confirma a exclusão do(a) Professor(a) [" + 
                                    tableModel.getValue(table.getSelectedRow()).getIdProfessor() + " - "
                            + tableModel.getValue(table.getSelectedRow()).getDescricaoProfessor() + "]?", "Confirm",
                    ...
                    JOptionPane.showMessageDialog(cp, "Escolha na tabela o(a) Professor(a) a ser excluíd0(a)");
                }
            }
        });
...
//========================================== botão add ============================================
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                professor.setIdProfessor(daoProfessor.autoIdProfessor());
                professor.setNomeProfessor("");
                professor.setDescricaoProfessor("");
                daoProfessor.inserir(professor);
                tableModel.onAdd(professor);
        ...
        btnRem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (table.getSelectedRow() != -1 && table.getSelectedRow() < tableModel.getRowCount()) {
                    Professor professor = tableModel.getValue(table.getSelectedRow());
        ...
        btnCarregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    List<Professor> lc = daoProfessor.list();
...
//============================================ listener table =======================================================
        ...
        tableModel.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent e) {
                // if (tableModel.mudou) {
                if (table.getSelectedRow() != -1 && table.getSelectedRow() < tableModel.getRowCount()) {
                    Professor c = tableModel.getValue(table.getSelectedRow());
                    daoProfessor.atualizar(c);
                }
                //}
            }
...
//============================================ date editor =======================================================
    ...
    public static void main(String[] args) {
        new GUIProfessorJTable(new Point(880, 250), new Dimension(800, 600));
    }
}
