...
// @author Radames
public class GUIAlunoListagem extends JDialog {
    ...
    public GUIAlunoListagem(List<Aluno> texto, int posX, int posY, Dimension dimensao) {
        ...
        String[] colunas = new String[]{"Id do Aluno: ",
            "Nome do Aluno:",
            "Foto: ",};
        ...
        for (int i = 0; i < texto.size(); i++) {
            String[] linha = new String[]{String.valueOf(texto.get(i).getIdAluno()),
                String.valueOf(texto.get(i).getNomeAluno()),
                String.valueOf(texto.get(i).getFoto()),};
            model.addRow(linha);
        }
